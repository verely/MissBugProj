...
async function query(filterBy = {}) {
    ...
    try {
        ...
        logger.error(`Error occurred while query: ${err}. Filter parameters used: ${filterBy.title} ${filterBy.minSeverity}`);
        throw err
    }
}
...
async function remove(bugId) {
    try {
        ...
        logger.error(`Error occurred while bug ${bugId} removal: ${err}.`);
        throw error
    }
}
...
async function save(bugToSave){
    try {
        ...
        logger.error(`Error occurred while bug saving ${bugToSave.title}: ${err}.`);
        throw error
    }
}
